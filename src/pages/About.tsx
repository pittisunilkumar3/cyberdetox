...
const About = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title="About Us - Cyberdetox"
        description="We're a team of AI specialists on a mission to make artificial intelligence accessible and valuable for enterprises of all sizes."
      />
      {/* About Hero Section */}
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                >
                  <Link
                    to="#our-story"
                    className="bg-white text-cyberpink hover:bg-gray-100 font-semibold py-3 px-6 rounded-md transition-all duration-300 group inline-flex items-center"
                  >
                    Our Story
