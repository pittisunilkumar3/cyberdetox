...
const Contact = () => {
  return (
    <div className="min-h-screen">
      <SEO
        title="Contact Us - Cyberdetox"
        description="Have questions about our services or want to discuss your project? Get in touch with our team today."
      />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/90 mb-8 max-w-2xl">
                ...
                Get in touch with our team today and let's build something amazing together.
              </p>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 transform transition-all duration-300 hover:bg-white/15">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <a href="mailto:info@aicompany.com" className="text-white/80 text-sm hover:text-white">
                        info@aicompany.com
                      </a>
                    </div>
                  </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 transform transition-all duration-300 hover:bg-white/15">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <a href="tel:+11234567890" className="text-white/80 text-sm hover:text-white">
                        +1 (123) 456-7890
                      </a>
                    </div>
                  </div>
                ...
                <div className="relative">
                  ...
                  <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl p-6 relative z-10 shadow-xl border border-white/10">
                    ...
                    <div className="mt-6 bg-white/10 backdrop-blur-sm rounded-xl p-4">
                      <div className="flex items-center">
                        <div className="bg-cyberpink/20 p-3 rounded-full mr-4">
                  ...
                  <FloatingElement delay={0.7} className="absolute -top-4 -right-4 bg-white w-12 h-12 rounded-full shadow-lg flex items-center justify-center z-20">
                    <MessageSquare className="h-6 w-6 text-cyberpink" />
                  </FloatingElement>
                  ...
                  <FloatingElement delay={1.5} className="absolute -bottom-4 -left-4 bg-white w-10 h-10 rounded-full shadow-lg flex items-center justify-center z-20">
                    <Building className="h-5 w-5 text-cyberpurple" />
                  </FloatingElement>
                </div>
              </FloatingElement>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            {[
              ...
              <div key={index} className="bg-gray-50 rounded-xl p-6 hover:shadow-md transition-all duration-300">
                <div className="flex items-start">
                  <div className="mr-4 mt-1 text-cyberpink">
      ...
      <section className="section bg-gradient-to-r from-cyberpink/10 to-cyberpurple/10">
        <div className="container-custom">
          <div className="text-center mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={index} className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 group">
                <div className="bg-gradient-to-r from-cyberpink/20 to-cyberpurple/20 p-4 rounded-full inline-flex mb-4 group-hover:from-cyberpink group-hover:to-cyberpurple group-hover:text-white transition-all duration-300">
                  {feature.icon}
                </div>
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          <div className="mt-12 bg-gray-50 rounded-xl p-6 max-w-3xl mx-auto">
            <div className="flex items-start">
              <div className="mr-4 text-cyberpink">
              ...
              <div>
                ...
                <Link to="/case-studies" className="text-cyberpink font-medium hover:underline inline-flex items-center">
                  View Case Studies
              ...
              {[
                ...
                <div key={index} className="relative">
                  <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 h-full">
                    <div className="bg-gradient-to-r from-cyberpink to-cyberpurple text-white w-10 h-10 rounded-full flex items-center justify-center font-bold mb-4">
                      {step.step}
                    </div>
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          <div className="mt-12 bg-gradient-to-r from-cyberpink/10 to-cyberpurple/10 rounded-xl p-8 max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              <input
                ...
                className="flex-grow px-4 py-3 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-cyberpink/50"
              />
        ...
        <div className="container-custom">
          ...
          <div className="bg-white rounded-xl overflow-hidden shadow-sm border border-gray-100">
            ...
            <div className="p-6 grid md:grid-cols-3 gap-6">
              <div className="flex items-start">
                <div className="bg-cyberpink/10 p-3 rounded-full mr-4">
                  <MapPin className="h-6 w-6 text-cyberpink" />
                </div>
                <div>
              ...
              <div className="flex items-start">
                <div className="bg-cyberpink/10 p-3 rounded-full mr-4">
                  <Clock className="h-6 w-6 text-cyberpink" />
                </div>
                <div>
              ...
              <div className="flex items-start">
                <div className="bg-cyberpink/10 p-3 rounded-full mr-4">
                  <Phone className="h-6 w-6 text-cyberpink" />
                </div>
                <div>
