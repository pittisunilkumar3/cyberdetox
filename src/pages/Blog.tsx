...
const Blog = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title="Blog - Cyberdetox"
        description="Stay updated with the latest insights, trends, and best practices in AI, cybersecurity, and IT."
      />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="lg:col-span-2 text-center max-w-3xl mx-auto">
              ...
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                Stay updated with the latest insights, trends, and best practices in AI, cybersecurity, and IT from our team of experts.
              </p>
