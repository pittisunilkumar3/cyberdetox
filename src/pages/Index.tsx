  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="py-16 bg-white relative overflow-hidden">
            ...
            {[
              ...
              >
                <div className="bg-gradient-to-br from-white to-gray-50 p-6 rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:shadow-md">
                  <div className="inline-flex items-center justify-center bg-gradient-to-r from-cyberpink/10 to-cyberpurple/10 p-3 rounded-full mb-4 text-cyberpink">
                    {stat.icon}
                  </div>
                  <div className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-cyberpink to-cyberpurple bg-clip-text text-transparent mb-2">
        ...
        <div className="absolute top-1/4 right-1/4 w-64 h-64 rounded-full bg-cyberpink/5 blur-3xl animate-pulse-slow"></div>
        <div className="absolute bottom-1/4 left-1/4 w-80 h-80 rounded-full bg-cyberpurple/5 blur-3xl animate-pulse-slow animation-delay-1000"></div>
      </section>
      ...
      <section className="section bg-gradient-to-r from-cyberpink/5 to-cyberpurple/5 relative overflow-hidden">
        <div className="container-custom relative z-10">
          ...
          <div className="relative">
            ...
            <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-6">
              {processSteps.map((step, index) => (
                ...
                >
                  ...
                  >
                    <div className="absolute -top-3 -left-3 bg-gradient-to-r from-cyberpink to-cyberpurple text-white w-10 h-10 rounded-full flex items-center justify-center font-bold animate-pulse-slow">
                      {step.number}
                    </div>
                    <div className="mb-4 text-cyberpurple">
                      {step.icon}
                    </div>
                    ...
                    {index < processSteps.length - 1 && (
                      <div className="hidden lg:block absolute -right-3 top-1/2 transform translate-x-full -translate-y-1/2 text-cyberpink animate-bounce-horizontal">
            ...
            <div className="hidden lg:block absolute top-1/3 left-0 w-full h-0.5 bg-gradient-to-r from-cyberpink to-cyberpurple z-0"></div>
          </div>
        ...
        <div className="absolute bottom-0 right-0 w-64 h-64 rounded-full bg-cyberpink/10 blur-3xl animate-pulse-slow"></div>
        <div className="absolute top-1/4 left-1/4 w-32 h-32 rounded-full bg-cyberpurple/10 blur-2xl animate-pulse-slow animation-delay-1000"></div>
      ...
      {/* CTA Section */}
      <section className="section bg-gradient-to-r from-cyberpink to-cyberpurple text-white relative overflow-hidden">
        <div className="container-custom relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <FloatingElement animationType="slide-up" delay={0.4} hoverEffect={true}>
                <Link
                  to="/contact"
                  className="bg-white text-cyberpink font-semibold py-3 px-8 rounded-md hover:bg-gray-100 transition-all duration-300 hover:shadow-lg inline-flex items-center"
                >
                  Start Your AI Project
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Link>
