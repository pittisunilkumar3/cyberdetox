...
const ServicesPage = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title="Our Services - Cyberdetox"
        description="We offer a comprehensive range of AI solutions to help businesses innovate and gain competitive advantage."
      />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/90 mb-8 max-w-2xl">
                We offer a comprehensive range of IT and AI solutions to help businesses innovate, transform, and gain competitive advantage in today's digital landscape.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                <Link
                  to="/contact"
                  className="button-primary bg-white text-cyberpink hover:bg-gray-100 transform transition-all duration-300 hover:scale-105 hover:shadow-lg group"
                >
                ...
                <div className="relative">
                  ...
                  <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl p-6 relative z-10 shadow-xl border border-white/10">
                    <div className="grid grid-cols-3 gap-4">
                      {[
                        { icon: <Brain className="h-8 w-8" />, label: "AI", color: "bg-cyberpink/20" },
                        { icon: <Cloud className="h-8 w-8" />, label: "Cloud", color: "bg-cyberpurple/20" },
                        { icon: <Lock className="h-8 w-8" />, label: "Security", color: "bg-cyberorange/20" },
                        { icon: <Code className="h-8 w-8" />, label: "Dev", color: "bg-cyberpurple/20" },
                        { icon: <Database className="h-8 w-8" />, label: "Data", color: "bg-cyberpink/20" },
                        { icon: <Server className="h-8 w-8" />, label: "DevOps", color: "bg-cyberorange/20" },
                        { icon: <LineChart className="h-8 w-8" />, label: "Analytics", color: "bg-cyberpink/20" },
                        { icon: <Cpu className="h-8 w-8" />, label: "ML", color: "bg-cyberpurple/20" },
                        { icon: <Globe className="h-8 w-8" />, label: "Web", color: "bg-cyberorange/20" }
                      ].map((item, index) => (
                        <div
                          key={index}
                  ...
                  <FloatingElement delay={1.5} className="absolute -bottom-4 -right-4 bg-white w-10 h-10 rounded-full shadow-lg flex items-center justify-center z-20">
                    <Shield className="h-5 w-5 text-cyberpurple" />
                  </FloatingElement>
                </div>
              </FloatingElement>
            </div>
          ...
          <div className="space-y-24">
            {services.map((service, index) => (
              ...
              >
                ...
                <div className="relative">
                  <div className="bg-gradient-to-br from-cyberpink/20 to-cyberpurple/20 p-4 rounded-xl">
                    <LazyImage
                  ...
                  {index % 2 === 0 ? (
                    ...
                    <div className="absolute -z-10 -bottom-5 -left-5 w-full h-full bg-cyberpurple/5 rounded-xl"></div>
                  )}
                </div>
              </div>
            ))}
        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg opacity-90 mb-8">
              Contact us today to discuss how our IT and AI services can help your business achieve its goals.
            </p>
